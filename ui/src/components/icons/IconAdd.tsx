...
const IconAdd = (props: { color?: string; width?: string }) => {
  return (
    <svg
      version="1.1"
    ...
    >
      <g>
        ...
        />
        <path
          d="M431.2,350.2h-21.6v-21.6c0-6.8-5.5-12.3-12.3-12.3s-12.3,5.5-12.3,12.3v21.6h-21.6c-6.8,0-12.3,5.5-12.3,12.3
		s5.5,12.3,12.3,12.3h21.6v21.6c0,6.8,5.5,12.3,12.3,12.3s12.3-5.5,12.3-12.3v-21.6h21.6c6.8,0,12.3-5.5,12.3-12.3
		S438,350.2,431.2,350.2z"
        />
      </g>
    </svg>
  );
