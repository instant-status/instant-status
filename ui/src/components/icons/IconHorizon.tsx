...
const IconHorizon = (props: { color?: string; width?: string }) => {
  return (
    <svg
      version="1.1"
    ...
    >
      <g>
        <path
          d="M49.2,453.4h413.7c20.3,0,36.8-16.5,36.8-36.9V95.5c0-20.3-16.5-36.9-36.8-36.9H49.2c-20.3,0-36.8,16.5-36.8,36.9v321.1
        ...
        />
        <path
          d="M117.2,129.4c3.2,0,6.4-1.3,8.7-3.6c2.3-2.3,3.6-5.4,3.6-8.7c0-3.2-1.3-6.4-3.6-8.7c-4.6-4.6-12.8-4.6-17.3,0
		c-2.3,2.3-3.6,5.4-3.6,8.7c0,3.2,1.3,6.4,3.6,8.7C110.7,128.1,113.9,129.4,117.2,129.4z"
        />
        <path
          d="M163.4,129.4c3.2,0,6.4-1.3,8.7-3.6c2.3-2.3,3.6-5.4,3.6-8.7c0-3.2-1.3-6.4-3.6-8.7c-4.5-4.6-12.7-4.6-17.3,0
		c-2.3,2.3-3.6,5.4-3.6,8.7c0,3.2,1.3,6.4,3.6,8.7C157,128.1,160.2,129.4,163.4,129.4z"
        />
        <path
          d="M281.1,202.9h-50.3c-6.8,0-12.3,5.5-12.3,12.3v178.4c0,6.8,5.5,12.3,12.3,12.3h50.3c6.8,0,12.3-5.5,12.3-12.3V215.2
		C293.4,208.4,287.9,202.9,281.1,202.9z M268.9,381.4h-25.8V227.4h25.8V381.4z"
        />
        <path
          d="M384.9,266.9h-50.3c-6.8,0-12.3,5.5-12.3,12.3v114.5c0,6.8,5.5,12.3,12.3,12.3h50.3c6.8,0,12.3-5.5,12.3-12.3V279.1
		C397.1,272.3,391.6,266.9,384.9,266.9z M372.6,381.4h-25.8v-90h25.8V381.4z"
        />
        <path
          d="M177.4,296h-50.3c-6.8,0-12.3,5.5-12.3,12.3v85.4c0,6.8,5.5,12.3,12.3,12.3h50.3c6.8,0,12.3-5.5,12.3-12.3v-85.4
