...
const IconError = (props: { color?: string; width?: string }) => {
  return (
    <svg
      version="1.1"
    ...
    >
      <g>
        <path
          d="M418.4,115.9v-1c0-37.7-30.7-68.4-68.4-68.4H80c-37.7,0-68.4,30.7-68.4,68.4v1c0,23.3,11.7,43.9,29.6,56.2
        ...
        <path
          d="M211,216.4c-6.8,0-12.3,5.5-12.3,12.3c0,6.8,5.5,12.3,12.3,12.3h114.4c6.8,0,12.3-5.5,12.3-12.3c0-6.8-5.5-12.3-12.3-12.3
		H211z"
        />
        ...
        <path
          d="M470.3,289.6c-19.5-19.5-45.4-30.2-72.9-30.2c-27.5,0-53.4,10.7-72.9,30.2c-40.2,40.2-40.2,105.6,0,145.8
        ...
        />
        <path
          d="M430,329.9c-4.8-4.8-12.5-4.8-17.3,0l-15.3,15.3l-15.3-15.3c-4.8-4.8-12.5-4.8-17.3,0c-4.8,4.8-4.8,12.5,0,17.3l15.3,15.3
