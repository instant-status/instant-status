...
const IconLogs = (props: { color?: string; width?: string }) => {
  return (
    ...
    >
      <g>
        <path
          d="M49.2,453.4h413.7c20.3,0,36.9-16.5,36.9-36.9V95.5c0-20.3-16.5-36.9-36.9-36.9H49.2c-20.3,0-36.8,16.5-36.8,36.9v321.1
        ...
        />
        <path
          d="M70.8,129.4c3.2,0,6.4-1.3,8.7-3.6c2.3-2.3,3.6-5.5,3.6-8.7c0-3.2-1.3-6.4-3.6-8.7c-4.6-4.6-12.8-4.6-17.3,0
		c-2.3,2.3-3.6,5.4-3.6,8.7c0,3.2,1.3,6.4,3.6,8.7C64.5,128.1,67.6,129.4,70.8,129.4z"
        />
        <path
          d="M117.2,129.4c3.2,0,6.4-1.3,8.7-3.6c2.3-2.3,3.6-5.5,3.6-8.7c0-3.2-1.3-6.4-3.6-8.7c-4.6-4.6-12.8-4.6-17.3,0
		c-2.3,2.3-3.6,5.4-3.6,8.7c0,3.2,1.3,6.4,3.6,8.7C110.8,128.1,113.9,129.4,117.2,129.4z"
        />
        <path
          d="M163.4,129.4c3.2,0,6.4-1.3,8.7-3.6c2.3-2.3,3.6-5.5,3.6-8.7c0-3.2-1.3-6.4-3.6-8.7c-4.6-4.6-12.7-4.6-17.3,0
		c-2.3,2.3-3.6,5.4-3.6,8.7c0,3.2,1.3,6.4,3.6,8.7C157,128.1,160.2,129.4,163.4,129.4z"
        />
        <path
          d="M429.3,207.6H82.7c-6.8,0-12.3,5.5-12.3,12.3c0,6.8,5.5,12.3,12.3,12.3h346.6c6.8,0,12.3-5.5,12.3-12.3
        ...
        />
        <path
          d="M256,374.1H82.7c-6.8,0-12.3,5.5-12.3,12.3c0,6.8,5.5,12.3,12.3,12.3H256c6.8,0,12.3-5.5,12.3-12.3
